    ...
    <div className="min-h-screen bg-background pt-24 pb-16 overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 md:px-8 w-full">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-title-lg text-on-surface-variant max-w-[43.75rem] mx-auto leading-relaxed">
        ...
        <motion.section 
          ...
          className="text-center bg-primary text-on-primary rounded-[2rem] p-12 md:p-20 relative overflow-hidden shadow-2xl"
        >
          <div className="absolute inset-0 opacity-10 flex items-center justify-center pointer-events-none">
            <Globe2 className="w-[37.5rem] h-[37.5rem] animate-[spin_90s_linear_infinite]" />
          </div>
          <div className="relative z-10">
            <h2 className="text-display-sm font-bold mb-6">Join the Movement</h2>
            <p className="text-title-lg opacity-90 max-w-[37.5rem] mx-auto mb-10">
