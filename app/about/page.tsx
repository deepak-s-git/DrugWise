...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-background pt-28 pb-20 overflow-hidden">
      <div className="max-w-[64rem] mx-auto px-4 md:px-8 w-full">
        ...
        >
          <motion.div variants={itemVariants} className="inline-block mb-6 px-5 py-2 rounded-full border border-primary/20 bg-primary/5">
            <span className="text-sm font-bold tracking-widest uppercase text-primary">Our Mission</span>
          </motion.div>
          
          <motion.h1 variants={itemVariants} className="text-4xl md:text-6xl font-bold text-on-surface mb-8 leading-tight">
          ...
          <motion.p variants={itemVariants} className="text-xl text-on-surface-variant max-w-[44rem] mx-auto leading-relaxed">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <motion.div variants={itemVariants} className="md:col-span-8">
              <SpotlightCard className="h-full p-8 md:p-10 flex flex-col justify-end bg-surface-container-low min-h-[18rem]">
                <div className="bg-primary/10 w-16 h-16 rounded-2xl flex items-center justify-center mb-8 shadow-sm">
                  <Database className="text-primary w-8 h-8" />
                </div>
                <h3 className="text-2xl font-bold text-on-surface mb-3">Open-Source Database</h3>
            ...
            <motion.div variants={itemVariants} className="md:col-span-4">
              <SpotlightCard className="h-full p-8 flex flex-col justify-end bg-surface-container-low min-h-[18rem]">
                ...
                <h3 className="text-xl font-bold text-on-surface mb-2">Clinical Comparisons</h3>
            ...
            <motion.div variants={itemVariants} className="md:col-span-4">
              <SpotlightCard className="h-full p-8 flex flex-col justify-end bg-surface-container-low min-h-[18rem]">
                ...
                <h3 className="text-xl font-bold text-on-surface mb-2">Blister Scanning</h3>
                <p className="text-body-md text-on-surface-variant">
            ...
            <motion.div variants={itemVariants} className="md:col-span-8">
              <SpotlightCard className="h-full p-8 md:p-10 flex flex-col justify-end bg-surface-container-low min-h-[18rem] overflow-hidden relative group">
                ...
                <div className="absolute right-0 bottom-0 opacity-[0.03] pointer-events-none translate-x-1/4 translate-y-1/4 transition-transform duration-1000 group-hover:scale-110 group-hover:-rotate-3">
                  <Code className="w-[18rem] h-[18rem]" />
                </div>
                <div className="relative z-10">
                  <div className="bg-primary/10 w-16 h-16 rounded-2xl flex items-center justify-center mb-8 shadow-sm">
                    <ShieldCheck className="text-primary w-8 h-8" />
                  </div>
                  <h3 className="text-2xl font-bold text-on-surface mb-3">Privacy First. Community Driven.</h3>
                  <p className="text-body-lg text-on-surface-variant max-w-[32rem]">
        ...
        <motion.section 
          ...
          className="text-center bg-primary text-on-primary rounded-3xl p-12 md:p-20 relative overflow-hidden shadow-2xl"
        >
          <div className="absolute inset-0 opacity-10 flex items-center justify-center pointer-events-none">
            <Globe2 className="w-[36rem] h-[36rem] animate-[spin_90s_linear_infinite]" />
          </div>
          <div className="relative z-10">
            <h2 className="text-3xl font-bold mb-6">Join the Movement</h2>
            <p className="text-xl opacity-90 max-w-[36rem] mx-auto mb-10">
            ...
            <a 
              ...
              target="_blank" 
              rel="noreferrer"
              className="inline-block px-8 py-4 bg-surface text-primary rounded-full font-bold text-lg hover:scale-105 hover:bg-secondary hover:text-on-secondary active:scale-95 transition-all duration-300 shadow-xl"
            >
              View Source Code
            </a>
          </div>
