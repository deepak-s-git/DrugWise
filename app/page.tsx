...
export default function HomePage() {
  ...
  // Animate from center of screen (+170px down to fit perfectly in the slit) to a comfortable top position (-20px)
  const titleY = useTransform(scrollY, [0, scrollEnd], [170, -20]);
